...
public:
  ...
  typename std::vector<typename boost::graph_traits<Graph>::edge_descriptor> &GetEdgeTraversal() const { return *traversal_edges; }
  typename std::vector<typename boost::graph_traits<Graph>::vertex_descriptor> &GetVertexTraversal() const { return *traversal_vertices; }
