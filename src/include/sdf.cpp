...
void new_sdf(Eigen::MatrixXd &V, Eigen::MatrixXi &F, Eigen::MatrixXd &face_sdf, Eigen::MatrixXd &vertex_sdf, Eigen::MatrixXd &skeleton_vertices,
...
void sdf(Eigen::MatrixXd &V, Eigen::MatrixXi &F, Eigen::MatrixXd &face_sdf, Eigen::MatrixXd &vertex_sdf, Eigen::MatrixXd &skeleton_vertices){
  Polyhedron tmesh;
  igl::copyleft::cgal::mesh_to_polyhedron(V,F,tmesh);
  // extract the skeleton
  Skeleton skeleton;
